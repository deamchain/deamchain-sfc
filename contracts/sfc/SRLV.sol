 ...
 */
contract SDEAM is ERC20, ERC20Detailed, ERC20Mintable, ERC20Burnable, Ownable, WhitelistedRecipientRole, WhitelistedSenderRole {
    ...
    constructor() public {
        ...
        ERC20Detailed.initialize("Staked DEAM", "DEAM", 18);
    ...
    function transfer(address to, uint256 value) public returns (bool) {
        require(isWhitelisted(msg.sender, to), "SDEAM: not whitelisted");
        return ERC20.transfer(to, value);
    }

    function transferFrom(address sender, address recipient, uint256 amount) public returns (bool) {
        require(isWhitelisted(msg.sender, recipient), "SDEAM: not whitelisted");
        return ERC20.transferFrom(sender, recipient, amount);
    }

    function approve(address spender, uint256 value) public returns (bool) {
        require(isWhitelisted(msg.sender, spender), "SDEAM: not whitelisted");
